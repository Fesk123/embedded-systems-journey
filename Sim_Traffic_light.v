...
module Sim_Traffic_light;
    ...
    Traffic_light dut (
        ...
        .green(green),
        .state(state)
    ); // dut (device under test) is the instance of the Traffic_light module that we are testing. It is connected to the inputs and outputs of the Sim_Traffic_light module. In python, we would say that dut is an object of the Traffic_light class. In verilog, we say that dut is an instance of the Traffic_light module.

    always #5 clk = ~clk;

    initial begin
        $dumpfile("traffic.vcd");
        $dumpvars(0, Sim_Traffic_light);
